...
CREATE TABLE IF NOT EXISTS cita_evento (
    ...
    tipo_evento ENUM('REPROGRAMADA', 'CANCELADA', 'NOTIFICADA', 'NOTIFICACION_FALLIDA', 'SEGUIMIENTO_CREADO', 'ATENDIDA', 'NO_ASISTIO') NOT NULL,
...
ALTER TABLE cita_evento
    MODIFY tipo_evento ENUM('REPROGRAMADA', 'CANCELADA', 'NOTIFICADA', 'NOTIFICACION_FALLIDA', 'SEGUIMIENTO_CREADO', 'ATENDIDA', 'NO_ASISTIO') NOT NULL;
